...
function _call(address _add, bytes memory _data, uint256 _value, bool _revertOnFailure, string memory _tracingInfo)
...
contract OpsProxyMock {
    ...
    function executeCall(address _target, bytes calldata _data, uint256 _value) external payable {
